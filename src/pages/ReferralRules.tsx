...
import { Gift, CheckCircle, XCircle, HelpCircle, AlertTriangle, Share2, UserPlus, Mail, Shield, Star, ChevronRight } from "lucide-react";
...
const steps = [
  ...
  { icon: Mail, text: "নতুন ইউজারকে ইমেইল ভেরিফাই করতে হবে" },
  { icon: Gift, text: "সব শর্ত পূরণ হলে আপনি ৫,০০০ রেফার পয়েন্ট পাবেন" },
];

const validRules = [
  "নতুন ইউজার রেফার লিংক বা রেফার কোড দিয়ে সাইন আপ করেছে",
  "নতুন ইউজার অ্যাকাউন্ট রেজিস্ট্রেশন সম্পূর্ণ করেছে",
  "নতুন ইউজার ইমেইল সফলভাবে ভেরিফাই করেছে",
...
const invalidRules = [
  ...
  "একই ডিভাইস থেকে একাধিক অ্যাকাউন্ট খোলা যাবে না",
  "ভুয়া বা ডুপ্লিকেট অ্যাকাউন্ট অনুমোদিত নয়",
  "ইমেইল ভেরিফিকেশন অসম্পূর্ণ থাকলে রেফার পয়েন্ট দেওয়া হবে না",
  "অ্যাকাউন্ট রেজিস্ট্রেশন অসম্পূর্ণ থাকলে রেফার পয়েন্ট দেওয়া হবে না",
  "টেম্পোরারি/ডিসপোজেবল ইমেইল অনুমোদিত নয়",
...
const faqs = [
  {
    ...
    a: "রেফার পয়েন্ট শুধুমাত্র তখনই যুক্ত হবে যখন রেফার্ড ইউজার সকল শর্ত পূরণ করবে — সাইন আপ, ইমেইল ভেরিফিকেশন এবং প্রোফাইল সম্পূর্ণ করা।",
  },
  {
    q: "ইমেইল ভেরিফাই না করলে কি রেফার পয়েন্ট পাব?",
    a: "না। ইমেইল ভেরিফিকেশন বাধ্যতামূলক। ইমেইল ভেরিফাই ছাড়া রেফার পয়েন্ট দেওয়া হবে না।",
  },
  {
    q: "একই ব্যক্তি কি একাধিক অ্যাকাউন্ট খুলতে পারবে?",
    a: "না। প্রতিটি ডিভাইস থেকে শুধুমাত্র একটি অ্যাকাউন্ট তৈরি করা যাবে। ডুপ্লিকেট বা ভুয়া অ্যাকাউন্ট অনুমোদিত নয়।",
  },
  {
        ...
        <div className="max-w-lg mx-auto">
          ...
          <div className="glass-card neon-border p-5 mb-6">
            ...
            <ul className="space-y-2">
              {[
                "প্রতি সফল রেফারে ৫,০০০ পয়েন্ট",
