...
const rules = [
  ...
  { q: "প্রতি মাসে কতবার খেলা যায়?", a: "প্রতি মাসে ১০টি র‍্যাঙ্কড সুযোগ পাবেন। প্র্যাকটিস সীমাহীন।" },
  { q: "লিডারবোর্ডে কোন স্কোর যায়?", a: "শুধুমাত্র মাসের সেরা স্কোর লিডারবোর্ডে গণনা হয়।" },
